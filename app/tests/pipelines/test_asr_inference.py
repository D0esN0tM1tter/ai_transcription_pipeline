...
class TestSpeechRecognitionModel(unittest.TestCase):
    ...
    def setUp(self):
        audio = Audio(
            ...
            audio_filepath="app/tests/test_data/audios/audio_4788a9972eb94994b59a80f5b1d508d1_job_814bdfe3e0b640779939d0522aa08a0e.wav",
            language="french"
        )
    ...
    def test_asr_model(self):
        result: Transcription = self.asr_model.transcribe(audio=self.processed_audio)
